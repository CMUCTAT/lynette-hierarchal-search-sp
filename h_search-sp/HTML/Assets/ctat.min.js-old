...
function(a){A=a;m&&(m.innerHTML=a)};this.getCurrentHint=function(){return l.innerHTML};this.init=function(){a.ctatdebug("init ("+a.getName()+")");a.setInitialized(!0);a.setIsAbstractComponent(!0);u=this.getDivWrap();u.id||u.setAttribute("id",CTATGlobalFunctions.gensym.div_id());u.setAttribute("onkeypress","return noenter(event)");a.setComponent(u);a.addComponentReference(a,u);l=document.createElement("div");u.appendChild(l);l.classList.add("CTATHintWindow--hint-content");var c=document.createElement("div");
c.classList.add("CTATHintWindow--hint-button-area");u.appendChild(c);if(A)m=document.createElement("button"),m.classList.add("CTATHintWindow--previous"),m.innerHTML=A;else{m=document.createElement("button");m.classList.add("CTATHintWindow--previous");var b=document.createElement("span");b.classList.add("CTATHintWindow--button-icon");b.textContent="\u25c0";m.appendChild(b);w&&(b.style.cssFloat="left",m.appendChild(document.createTextNode(w)))}m.addEventListener("click",function(a){CTATShellTools.showPrevHint()},
!1);c.appendChild(m);n=document.createElement("div");n.classList.add("CTATHintWindow--hint-indicator");c.appendChild(n);v?(p=document.createElement("button"),p.classList.add("CTATHintWindow--next"),p.innerHTML=v):(p=document.createElement("button"),p.classList.add("CTATHintWindow--next"),b=document.createElement("span"),b.classList.add("CTATHintWindow--button-icon"),b.textContent="\u25b6",q&&(b.style.cssFloat="right",p.appendChild(document.createTextNode(q))),p.appendChild(b));p.addEventListener("click",
...
b.prototype.interpolate=function(a,b,c,d){var e,f,g,h,l;h=a.split(this.interpolateSplitPattern);l=[];a=f=0;for(g=h.length;f<g;a=++f)e=h[a],l.push(a%2?this.evaluate(e,b,c,d):e);return l.join("")};return b}();"undefined"!==typeof module&&null!==module?module.exports=b:this.CTATFormulaParser=b}).call(this);var CTATNoolsTracer=function(b,g,f){var e,c,a,d;function h(a){wa=[];M.setDoBacktracking(!1);K("debug","starting initial match");xa=function(){K("debug","done initial match");ka=la=!0;M.setPruneOldActivations(X.prune_old_activations);M.setDoBacktracking(X.use_backtracking);M.setSearchAllPermutations(X.search_all_permutations);ha=!0;"function"===typeof a&&a()};F()}function l(){K("debug","start conflict tree pregeneration...");ja=!0;ea=[];var a=0;0===ma.length&&ma.push({selection:"not_specified",action:"not_specified",
input:"not_specified"});var b=function(){++a>=ma.length?c():n(ma[a],b)},c=function(){K("debug","done conflict tree pregeneration");ja=!1;ya();ya=function(){}};X.use_hint_fact?(a--,n(null,b,!0)):n(ma[a],b)}function n(a,b,c){M.prepForMatch();x();var d;d=c?r():C(a,!0);F(null,function(){M.retract(d);ka=!0;var e=M.getConflictTree();c?ea.__hintTree=[Y,e]:ea.push([a,Y,e]);b()})}function m(a,b,c){var d=null,e=null,f=null;if("untutored_action"===c)return C(a,!1),l(),!0;"hint"===c&&ea.__hintTree&&(e=E(!0,a.selection,
...
Y.matchChain?(c=Y.matchChain,b="correct"):(Y.bugMatchChains.length&&(c=Y.bugMatchChains.sort(function(a,b){return b.priority-a.priority})[0],b="bug",d=c.msg),c=E(!1),d&&(c.msg=d));la="correct"===b;c.tpas=Ba;ka=!0;ca=null;a(b,c)}function z(a,b,c){c=E(!0,c);b&&(la=Ca=!1,ka=!0,ca=null,X.use_hint_fact&&M.retract(ta));a(c)}function E(a,b,c){K("debug","getBiasedPrediction selecting chain to return.  includeHints is "+a+", optSelection is "+b);var d,e=c||Y,f=e.selectionMap;b=b||(ca?ca.selection:"");c=e.firstPredictedSolution;
...
"function"===typeof c)n.isMatch=c(a,b);else for(n.isMatch=!0,a=0;3>a;a++)if("-"===m[a]){n.isMatch=!1;break}return n}function x(){Y=new ua;e=[];c=[];a=null;na=d=!1}function H(a,b){K("debug","setProblemAttribute ("+a+", "+b+")");X[a]=b}function J(a){M.setNodeData(a)}function V(){for(var b=e,c=Y.selectionMap,f,g,h={message:"",priority:Number.NEGATIVE_INFINITY},l,m=[],n=[],p=[],u=[],q=[],w,r={selection:"",action:"",input:""},v=null,z={},J=d?ja?1:2:0,H=0,da=0;da<b.length;da++)f=b[da],g=f.sai,n.push(f.ruleName),
...
b){var c=b.precedence-a.precedence;0===c&&(c=a.pos-b.pos);return c});w?Y.firstTutorSelection||(Y.firstTutorSelection=w):w="_default_key";c[w]||(c[w]=[]);b=new va(r,n,p,u,h,z,m,v,q,J,H);r.isCorrect&&!Y.firstPredictedSolution&&(Y.firstPredictedSolution=b);c[w].push(b);switch(a){case "buggy":Y.bugMatchChains.push(b);break;case "match":Y.matchChain=b}Y.numChains++;Ba=q;K("debug","stored last chain: \n\trules: "+n+"\n\tskills: "+p+"\n\thints: "+u.map(function(a){return a.msg})+"\n\tfinalSAI: "+JSON.stringify(r)+
"\n\tmatchType: "+a+"\n\tmsg: "+h+"\n\tpriority: "+H)}function O(a){X.use_backtracking&&M.pushUndo("assert",a);return M.assert(a)}function L(a){X.use_backtracking&&M.pushUndo("retract",a);return M.retract(a)}function D(a,b,c){if(X.use_backtracking)M.pushUndo("modify",a,b);else if(3>arguments.length)return M.modify.apply(M,arguments);a[b]=c;return M.modify(a)}function P(a,b){if(X.use_backtracking)M.pushUndo("bulkModify",a,Object.keys(b));else if(2>arguments.length)return M.modify.apply(M,arguments);
for(var c in b)a[c]=b[c];return M.modify(a)}function S(){d=!0;ja?M.setAboutToBacktrack():(M.halt(!0),na=!0)}function T(){M.undoAll(!0)}function R(){var a=M.pruneOldActivations();K("debug","pruned old activations: "+a.join(","))}function W(){if(!ja)for(var a=0;a<arguments.length;a++){var b=arguments[a];!b.selection&&(b.selection="not_specified");!b.action&&(b.action="not_specified");!b.input&&(b.input="not_specified");ma.push(b)}}function N(){V()}function Q(a){Da||c.pop();Da=!1;Ba=[];K("backtrack",
"backtracking, initiated by "+(a?"model":"engine"))}function U(a,b,c,d){var f;try{f=JSON.stringify(a)}catch(Na){f="< Error converting fact to JSON >"}K("assert",b+" fact asserted with ID "+d+": "+f);c=e[e.length-1];switch(b){case "tpa":K("tpa","TPA asserted: "+JSON.stringify(a));ha?X.use_backtracking?c.tpas.push(a):La(a):wa.push(Z.buildStartStateMsg(a));break;case "hint":ha&&(a.pos=+(e.length+"."+c.hints.length),c.hints.push(a));break;case "skill":ha&&c.skills.push(a.name+" "+a.category);break;case "customfield":ha&&
c.customFields.push(a)}}function aa(a,b,c,d){K("modify",b+" fact modified with ID "+d)}function fa(a,b,c,d){K("retract",b+" fact retracted with ID "+d)}function ia(b){K("state_save","Hit branch point, agenda: "+JSON.stringify(b.agenda)+", factIdCntr: "+b.state.factIdCounter);c.push({numLinks:e.length,matchType:a})}function ga(b){K("state_restore","State restored, agenda: "+JSON.stringify(b.agenda)+", factIdCntr: "+b.state.factIdCounter);b=c;b=b[b.length-1];links=e;links.splice(b.numLinks);a=b.matchType}
function pa(a,b,c){K("fire","Firing activation: "+c);e.push(new Ka(a,c));Da=!0}function da(a,b,c){K("agenda_insert",a+" added to agenda, is "+(b?" ":"not ")+"new, was "+(c?" ":"not ")+"skipped")}function Ha(a){K("agenda_retract",a+" removed from agenda")}function Ia(){K("agenda_empty","No more activations in agenda, all branches have been explored");na=!0}function Ja(a){K("override","hit breakpoint on rule "+a+" (call resume() to resume matching)")}var ua=function(){this.firstTutorSelection=null;
this.selectionMap={};this.matchChain=null;this.bugMatchChains=[];this.numChains=0;this.firstPredictedSolution=null},va=function(a,b,c,d,e,f,g,h,l,m,n){this.sai=a||{selection:"",action:"",input:""};this.rules=b||[];this.skills=c||[];this.hints=d||[];this.msg=e?e.message:"";this.customFields=f||{};this.activationIds=g||[];this.saiComparator=h||null;this.tpas=l||[];this.halted=m;this.priority=n||0},Ka=function(a,b){this.ruleName=a;this.activationId=b;this.hints=[];this.tpas=[];this.skills=[];this.customFields=
[]},K=b,La=g,Ea=f,ba=this,ha=!1,oa=null,M=null,sa={},Y=new ua,ca=null,Fa=0;e=[];c=[];a=null;var Da=d=!1,Z=null,wa=[],X={use_backtracking:!0,prune_old_activations:!1,use_hint_fact:!1,search_all_permutations:!0,hint_out_of_order:!1,substitute_input:!1,auto_hint:"none",auto_hint_threshold:3},la=!0,Ca=!1,ta=null,za={},Ba=[],qa=!1,ka=!0,xa=function(){},na=!1,ma=[],ja=!1,ya=function(){},ea=[],ra=null,Aa=null,Ga;this.getSession=function(){return M};this.getInitialized=function(){return ha};this.getSkills=
function(){return za};this.getProblemAttribute=function(a){return X[a]};this.getProblemStateStatus=function(){return Ea.getOutputStatus()};this.init=function(a,b,c){K("debug","noolstracer init w/ source file: "+a);if(nools){Z=new CTATNoolsTracerUtil;var d=Z.relativeToAbsolute(a);$.ajax(a,{dataType:"text",success:function(e){w(e,d,null,function(d){K("debug","compiling model...");!0!==(d=A(d,a))?(K("error","CTATNoolsTracer: Error compiling model"),c(d)):(K("debug","done compile"),ba.createSession()||
c("CTATNoolsTracer: Error creating session"),registerTracerWrapper(new CTATNoolsTracerWrapper(ba)),h(function(){K("override","tracer initialized, log flags: ");getTracerLogFlags();printBreakpoints();b(wa,X);var a=new Event("noolsModelLoaded");window.dispatchEvent(a);X.pregen_conflict_tree&&l()}))})},error:function(a,b,d){ctatdebug("Error retrieving rule file: ");ctatdebug(b);c(b)}})}else K("error","Error: nools is not defined"),c("nools is not defined")};this.createSession=function(){K("debug","creating session...");
(M=oa.getSession({iAmEventListeners:!0,assert:U,retract:fa,modify:aa,state_save:ia,state_restore:ga,backtrack:Q,fire:pa,agenda_insert:da,agenda_retract:Ha,agenda_empty:Ia,endOfChain:N,breakpoint:Ja}))&&K("debug","session created");return!!M};this.evaluate=function(a,b,c){K("debug","noolsTracer.evaluate, matchType = "+c+", sai "+JSON.stringify(a)+", "+la);Ga=Date.now();if(X.pregen_conflict_tree)return m(a,b,c);var d=B.bind(ba,b);M.prepForMatch();switch(c){case "hint":if(la||X.use_hint_fact)Ca=!0,d=
z.bind(ba,b,!0),X.use_hint_fact&&r();else return K("debug","re-using hints from last match"),z(b,!1,a.selection),!0;case "tutored_action":x();C(a,!0);xa=function(){M.prepForMatch();M.restoreAgenda();ba.printTraceTime();ba.printAgenda("agenda_post");ba.printConflictTree("conflict_tree");d()};qa||(ba.printAgenda("agenda_pre"),F());break;case "untutored_action":return C(a,!1),!0}return!1};this.setListener=function(a,b){M&&M.on(a,b)};this.getStudentSAIs=function(){return sa};this.getLastStudentSAI=function(){return ca};
this.getTutorSAIs=function(){return Y.selectionMap};this.reset=function(a){ba.createSession();ha=!1;sa={};Y=new ua;ca=null;la=!0;h(a)};this.printTraceTime=function(){var a=(Date.now()-Ga)/1E3;K("time","trace took "+a+" seconds.")};this.printAgenda=function(a){K(a,Z.printAgenda(M))};this.printConflictTree=function(a,b,c){K(a,"\n"+Aa.toString(b,c))};this.printPregenTrees=function(a,b,c){ea.__hintTree&&K(a," hint tree: \n"+ea.__hintTree[1].toString(b,c));ea.forEach(function(d){K(a," tree for sai: "+
JSON.stringify(d[0])+"\n"+d[2].toString(b,c))})};this.printTutorSAIs=function(a,b){var c="";Aa.getMatchChains().forEach(function(a){var d=a.match.tutor;c+="\n"+d.selection+" ; "+d.action+" ; "+d.input;b&&(c+=" \n "+a.rules.join(",")+"\n")});K(a,c)};this.printFact=function(a){K("override",Z.printFact(M,a))};this.printFacts=function(a){K("override",Z.printFacts(M,a))};this.printRules=function(a){K("override",Z.printRules(M,a))};this.getFact=function(a){return Z.getFact(M,a)};this.getFacts=function(a){return Z.getFacts(M,
a)};this.printCtNodeMatch=function(a){K("override",Z.printCtNodeMatch(M,a))};this.printRuleNodes=function(a){K("override",Z.printRuleNodes(M,a))};this.printBreakpoints=function(){K("override",Z.printBreakpoints(M))};this.setInStepMode=function(a){a=a&&"false"!==a;K("override","Stepper mode "+(a?"on":"off"));!qa||a||na||F();qa=a};this.takeSteps=function(a){qa?ca?(a=a||1,K("override","taking "+a+" steps"),F(a)):K("override","no new student input, ignoring"):K("override","not in step mode, ignoring")};
this.setBreakpoint=function(a,b){a?(b=b||"first",M.setBreakpoint(a,b)?K("override","breakpoint "+("none"===b?"cleared":"set")+" for rule "+a):K("override","breakpoint not "+("none"===b?"cleared":"set")+" -- rule "+a+" doesn't exist")):K("override","need a rule name to break on")};this.resume=function(){qa?K("override","can't resume; engine is in stepper mode"):na?K("override","not at a breakpoint, ignoring"):F()};this.getIAmPregenerating=function(){return ja};this.setDonePregenCallback=function(a){K("debug",
